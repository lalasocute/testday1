...
# 1、文件数据读取
df = pd.read_csv("G:\rabbish-data\Chinese_Spam_Filter-master\data\result_process01",sep=",",header=None,
...
#结果输出到CSV文件中
df.to_csv("G:\rabbish-data\Chinese_Spam_Filter-master\data\result_process02",encoding="utf-8",index=False)
